...
import com.ruandenecker.bloghog.databinding.FragmentBlogItemDetailBinding
    ...
    override fun onCreateView(
        ...
        db.collection("blogs").document(args.blogId).get()
            ...
            .addOnFailureListener {
                ...
                findNavController().navigate(R.id.action_blogItemDetailFragment_to_listAllBlogsFragment2)
            }
